<template>
  <div>
    ...
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>图标列表</el-breadcrumb-item>
    </el-breadcrumb>
    <!--卡片区域-->
    <!--搜索-->
    <el-card class="box-card">
          <el-link type="success" href="https://element.eleme.io/#/zh-CN/component/icon">ICON链接</el-link>
      <ul class="icon-list">
        <li>
          <span>
...
ul li{list-style: none;padding: 0;margin: 0;font-size: 30px}
</style>